    ...
    const renderContent = () => {
        switch (page) {
            ...
            case 2:
                return (
                    <>
                        <Typography variant='h2' className={Styles.h2}>Gostos Pessoais</Typography>
                        <Typography className={Styles.p} variant='body1'>
                            ...
                            Além das viagens, tenho um grande apreço por esportes como futebol e ciclismo, que me ajudam a manter um estilo de vida ativo e saudável. No universo dos games, sou fã do estilo battlegrounds, que sempre me proporciona momentos de diversão e desafio.
                            Valorizo muito o tempo com minha família e adoro aproveitar os fins de semana para estar com eles, seja em atividades ao ar livre ou em momentos de lazer. Sou um grande apreciador de filmes e séries, e meus gêneros preferidos são os de guerra e de heróis. As histórias intensas e inspiradoras desses gêneros sempre me envolvem e me fascinam.
                        </Typography>
                    </>
                );
            case 3:
                return (
                    <>
                        <Typography variant='h2' className={Styles.h2}>Motivações</Typography>
                        <Typography className={Styles.p} variant='body1'>
                            Minhas principais motivações na vida giram em torno de construir um futuro melhor e viver de maneira plena. Acredito que a tecnologia será a chave para alcançar esses objetivos, pois ela abre portas para inúmeras oportunidades e inovações. Tenho muitos sonhos, entre eles conhecer Machu Picchu, um destino que sempre me fascinou. Estou aguardando ansiosamente pela minha primeira grande oportunidade na área de tecnologia, onde poderei mostrar todo meu potencial e provar que sou capaz. Nunca desistir dos meus sonhos é a força motriz que me impulsiona diariamente, e essa determinação é a minha principal motivação.
                        </Typography>
                    </>
                );
            default:
