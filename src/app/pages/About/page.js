          ...
          <div className={`${Styles.container} ${Styles.leftContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                Engenharia de Software para aprofundar meu conhecimento na área
                de tecnologia.
              </p>
              <p>
                A programação foi uma verdadeira virada de chave na minha vida.
                Em um momento em que estava em busca de crescimento pessoal e
                profissional, a tecnologia me ofereceu uma oportunidade de
                transformação e evolução. Decidi investir na programação não
                apenas como uma carreira, mas como uma forma de desenvolver
                novas habilidades e encontrar uma profissão que realmente me
                realizasse. Essa jornada tem sido emocionante e desafiadora, e
                estou empolgado com o futuro e as oportunidades que virão.
              </p>
          ...
          <div className={`${Styles.container} ${Styles.rightContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                não conseguir aprender. No entanto, o meu interesse e paixão
                pela tecnologia sempre foram maiores do que as dificuldades
                iniciais. Esse período de aprendizado inicial foi fundamental
                para despertar em mim a determinação e o entusiasmo necessários
          ...
          <div className={`${Styles.container} ${Styles.leftContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                desenvolvimento de páginas web estáticas e interativas, comecei
                a me interessar mais pelo desenvolvimento front-end. A
          ...
          <div className={`${Styles.container} ${Styles.rightContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                Next.js. Este novo projeto não só aprimorou minhas habilidades
                em desenvolvimento front-end, mas também me permitiu explorar
                recursos avançados e melhorar a funcionalidade e o desempenho
                das minhas aplicações.
              </p>
              <p>
                Além disso, em dezembro de 2023, concluí minha formação em
                Análise e Desenvolvimento de Sistemas. Esse marco acadêmico foi
                um passo importante na minha jornada, consolidando meu
          ...
          <div className={`${Styles.container} ${Styles.leftContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                buscando aprofundar ainda mais meu conhecimento e habilidades na
                área de tecnologia. Para refletir essa evolução, atualizei meu
                portfólio e desenvolvi vários novos projetos.
              </p>
              <p>
                Chegar até aqui foi uma jornada cheia de aprendizados e
                desafios, e estou em busca de uma oportunidade de trabalho, seja
                um estágio ou uma posição júnior. Acredito que posso evoluir
                ainda mais ao vivenciar projetos reais e aplicar meus
          ...
          <div className={`${Styles.container} ${Styles.rightContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                efeito renovador em mim, e sempre busco estar em contato com
                ela.
              </p>
              <p>
              ...
              <p>
                ...
                de filmes e séries, com uma preferência especial por aqueles com
                temas de guerra e heróis. As histórias intensas e inspiradoras
                desses gêneros sempre me envolvem e fascinam.
              </p>
              <span className={Styles.rightContainerArrow}></span>
            </div>
          </div>
          <div className={`${Styles.container} ${Styles.leftContainer}`}>
            ...
            <div className={Styles.textBox}>
              ...
              <p>
                ...
                exploração do mundo e tempo de qualidade com meus entes queridos
                formará a base de um futuro satisfatório e gratificante.
              </p>
              <span className={Styles.leftContainerArrow}></span>
            </div>
          </div>
