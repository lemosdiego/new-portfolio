            ...
            <Box className={Styles.containerPresentation}>
                ...
                <Box className={Styles.containerDescription}>
                    <Box className={Styles.containerApresentation}>
                        <Typography variant='h6' className={Styles.h6}>Olá a todos, eu sou</Typography>
                        <Typography variant='h1' className={Styles.h1}>Washington Lemos</Typography>
                        <Typography variant='h2' className={Styles.h2}>Front end web developer
                        </Typography>
                        <Typography className={Styles.p}>Sou programador front-end, natural de Recife, mas atualmente resido entre Recife e São Paulo. Tenho experiência com HTML, CSS, JavaScript e frameworks como React e Angular. Estou em busca de novas oportunidades para aplicar minhas habilidades e contribuir para projetos inovadores.</Typography>
                    </Box>
